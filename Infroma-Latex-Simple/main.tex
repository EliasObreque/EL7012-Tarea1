...
\begin{figure}[h!]
	...
	\captionsetup{justification=centering}
	\subfloat[Intervalo a 1 paso]{
		\includegraphics[width=0.5\textwidth]{imag/redes/js_1.pdf}}
	\subfloat[Intervalo a 8 paso]{
		\includegraphics[width=0.5\textwidth]{imag/redes/js_8.pdf}} \newline
	\subfloat[Intervalo a 16 paso]{
		\includegraphics[width=0.5\textwidth]{imag/redes/js_16.pdf}}
...
\begin{figure}[h!]
\centering
\includegraphics[width=10cm,height=7cm]{imag/P2/Sensibilidad24}
\caption{Índice de Sensibilidades.}
\label{f_P2Sensibilidad}
\end{figure}

	\item \textbf{Optimización de la estructura y los parámetros:}

La optimización de la estructura del modelo difuso consiste principalmente en determinar el número óptimo de reglas del modelo difuso, por lo que se trabajará con los 3 modelos anteriormente descritos:

\begin{itemize}
  \item Modelo 1: 24 regresores: $y(k-1)$,..., $y(k-24)$
  \item Modelo 2: 6 regresores: $y(k-1)$, $y(k-2)$, $y(k-10)$, $y(k-11)$, $y(k-12)$ y $y(k-24)$
  \item Modelo 3: 1 regresor: $y(k-1)$
\end{itemize}

En este caso se definió un número máximo de 10 clusters y se entrenó cada modelo para cada una de las posibles valores de clusters, utilizando como algoritmo de clustering el Fuzzy C-Means, Fig. \ref{f_P2Cluster}. Se escoge el número de cluster igual a 2 para los tres modelos ya que es un número de clusters aceptable para todos los modelos y además permite establecer condiciones de similitud para establecer comparaciones entre ellos. Para cada modelo y números de clusters se obtienen los parámetros del modelo. En la Fig. \ref{f_P2ClusterS} se nota que a medida que se disminuye el número de regresores, es más complejo para el algoritmo de clustering difuso poder asignar los grados de pertencia a los conjuntos difusos.

\begin{figure}
		\centering
		\captionsetup{justification=centering}
		\subfloat[Modelo 1]{
		 \includegraphics[width=0.5\textwidth]{imag/P2/Cluster24}}
		\subfloat[Modelo 2]{
		 \includegraphics[width=0.5\textwidth]{imag/P2/Cluster6}}\\
		\subfloat[Modelo 3]{
		 \includegraphics[width=0.5\textwidth]{imag/P2/Cluster1}}
		\caption{Índice de Sensibilidades.}
		\label{f_P2Cluster}
\end{figure}
...
\begin{figure}
		...
		\captionsetup{justification=centering}
		\subfloat[Modelo 1]{
		 \includegraphics[width=0.5\textwidth]{imag/P2/clusterSalidaM1}}
		\subfloat[Modelo 2]{
		 \includegraphics[width=0.5\textwidth]{imag/P2/clusterSalidaM2}}\\
		\subfloat[Modelo 3]{
		 \includegraphics[width=0.5\textwidth]{imag/P2/clusterSalidaM3}}
...
% Table generated by Excel2LaTeX from sheet 'P2'
\begin{table}[htbp]
  \centering
  \caption{Desempeño de los Modelos Difusos}
    ...
    \midrule
    Índices & \multicolumn{1}{p{3em}|}{Entre.} & \multicolumn{1}{p{3em}|}{Prueba} & \multicolumn{1}{p{3.9em}|}{Validación} & \multicolumn{1}{p{3em}|}{Entre.} & \multicolumn{1}{p{3em}|}{Prueba} & \multicolumn{1}{p{3.9em}|}{Validación} & \multicolumn{1}{p{3em}|}{Entre.} & \multicolumn{1}{p{3em}|}{Prueba} & \multicolumn{1}{p{3.9em}|}{Validación} \\

    \midrule
    RMSE  & 1.4751 & 0.8860 & 1.0761 & 1.6342 & 1.1371 & 1.1520 & 2.4171 & 2.7762 & 2.53811 \\
    \midrule
    MAPE  & 766.42 & 335.23 & 262.78 & 649.63 & 266.23 & 215.32 & 968.63 & 768.61 & 728.16 \\
    \midrule
    MAE   & 0.7572 & 0.5171 & 0.6014 & 0.8420 & 0.6363 & 0.6176 & 1.4398 & 1.6494 & 1.5828 \\
...
\begin{figure}
		...
		\captionsetup{justification=centering}
		\subfloat[Modelo 1]{
		 \includegraphics[width=0.5\textwidth]{imag/P2/Sal_r24}}
		\subfloat[Modelo 2]{
		 \includegraphics[width=0.5\textwidth]{imag/P2/Sal_r6}}\\
		\subfloat[Modelo 3]{
		 \includegraphics[width=0.5\textwidth]{imag/P2/Sal_r1}}
...
\begin{table}[htbp]
  ...
  \caption{ Desempeño de la predicción de los Modelos Difusos.}
    \begin{tabular}{|l|r|r|r|r|r|r|r|r|r|}
    \toprule
          & \multicolumn{3}{c|}{1 paso} & \multicolumn{3}{c|}{6 paso} & \multicolumn{3}{c|}{12 paso} \\
\cmidrule{2-10}    Índices &
\multicolumn{1}{p{3em}|}{Modelo 1} & \multicolumn{1}{p{3em}|}{Modelo 2} & \multicolumn{1}{p{3em}|}{Modelo 3} & \multicolumn{1}{p{3em}|}{Modelo 1} & \multicolumn{1}{p{3em}|}{Modelo 2} & \multicolumn{1}{p{3em}|}{Modelo 3} & \multicolumn{1}{p{3em}|}{Modelo 1} & \multicolumn{1}{p{3em}|}{Modelo 2} & \multicolumn{1}{p{3em}|}{Modelo 3} \\
    \midrule
    RMSE  & 1.0761 & 1.1371 & 2.5381 & 1.6011 & 1.7073 & 4.3392 & 8.8953 & 9.0658 & 5.0312 \\
    \midrule
    MAE   & 0.6014 & 0.616 & 1.5828 & 0.8204 & 0.9401 & 2.9788 & 5.653 & 5.9445 & 4.2140\\
    \bottomrule
    \end{tabular}%
  \label{t_MDP}%
\end{table}%
...
\begin{figure}
		...
		\captionsetup{justification=centering}
		\subfloat[Modelo 1]{
		 \includegraphics[width=0.5\textwidth]{imag/P2/Sal_r24_p6}}
		\subfloat[Modelo 2]{
		 \includegraphics[width=0.5\textwidth]{imag/P2/Sal_r6_p6}}\\
		\subfloat[Modelo 3]{
		 \includegraphics[width=0.5\textwidth]{imag/P2/Sal_r1_p6}}
...
\begin{figure}
		...
		\captionsetup{justification=centering}
		\subfloat[Modelo 1]{
		 \includegraphics[width=0.5\textwidth]{imag/P2/Sal_r24_p12}}
		\subfloat[Modelo 2]{
		 \includegraphics[width=0.5\textwidth]{imag/P2/Sal_r6_p12}}\\
		\subfloat[Modelo 3]{
		 \includegraphics[width=0.5\textwidth]{imag/P2/Sal_r1_p12}}
...
En las estimaciones a j-pasos los intervalos difusos cobran una mayor importancia, pues no solo se está predidiendo un valor, sino que además se indica con cual porciento de confianza dici valor se encuentra dentro de un intervalo de tal amplitud.
...
\multicolumn{1}{p{3em}|}{Modelo 1} & \multicolumn{1}{p{3em}|}{Modelo 2} & \multicolumn{1}{p{3em}|}{Modelo 3} & \multicolumn{1}{p{3em}|}{Modelo 1} & \multicolumn{1}{p{3em}|}{Modelo 2} & \multicolumn{1}{p{3em}|}{Modelo 3} & \multicolumn{1}{p{3em}|}{Modelo 1} & \multicolumn{1}{p{3em}|}{Modelo 2} & \multicolumn{1}{p{3em}|}{Modelo 3} \\
    \midrule
    PICP  & 98.85 & 98.85 & 90.83 & 96.77 & 97.08 & 78.4375 & 71.15 & 89.79 & 99.69 \\
    \midrule
    PINAW & 27.78 & 30.06 & 44.12 & 28.14 & 30.12 & 45.84 & 55.63 & 57.1  & 129.81 \\
    \bottomrule
    \end{tabular}%
  \label{t_MDPCov}%
\end{table}%
...
\begin{figure}
		...
		\captionsetup{justification=centering}
		\subfloat[Modelo 1]{
		 \includegraphics[width=0.5\textwidth]{imag/P2/SalCov_r24_p1}}
		\subfloat[Modelo 2]{
		 \includegraphics[width=0.5\textwidth]{imag/P2/SalCov_r6_p1}}\\
		\subfloat[Modelo 3]{
		 \includegraphics[width=0.5\textwidth]{imag/P2/SalCov_r1_p1}}
		\caption{Intervalo Difuso. Método de la covarianza}
		\label{f_P2SalidaCov}
\end{figure}
...
\begin{figure}
		...
		\captionsetup{justification=centering}
		\subfloat[Modelo 1]{
		 \includegraphics[width=0.5\textwidth]{imag/P2/SalCov_r24_p6}}
		\subfloat[Modelo 2]{
		 \includegraphics[width=0.5\textwidth]{imag/P2/SalCov_r6_p6}}\\
		\subfloat[Modelo 3]{
		 \includegraphics[width=0.5\textwidth]{imag/P2/SalCov_r1_p6}}
...
\begin{figure}
		...
		\captionsetup{justification=centering}
		\subfloat[Modelo 1]{
		 \includegraphics[width=0.5\textwidth]{imag/P2/SalCov_r24_p12}}
		\subfloat[Modelo 2]{
		 \includegraphics[width=0.5\textwidth]{imag/P2/SalCov_r6_p12}}\\
		\subfloat[Modelo 3]{
		 \includegraphics[width=0.5\textwidth]{imag/P2/SalCov_r1_p12}}
		\caption{Intervalo Difuso. Método de la covarianza. Predicción a 12 pasos}
		\label{f_P2SalidaCovp12}
\end{figure}
...
\begin{figure}[h!]
	...
	\captionsetup{justification=centering}
	\subfloat[Intervalo a 1 paso]{
		\includegraphics[width=0.5\textwidth]{imag/redes/p2_1.pdf}}
	\subfloat[Intervalo a 6 paso]{
		\includegraphics[width=0.5\textwidth]{imag/redes/p2_6.pdf}} \newline
	\subfloat[Intervalo a 12 paso]{
		\includegraphics[width=0.5\textwidth]{imag/redes/p2_12.pdf}}
	\caption{Uso del método de covarianza para estimar el intervalo de predicción a 1, 6 y 12 con $\alpha=10$.}
	\label{p2_j}
\end{figure}
...
\begin{figure}[h!]
	...
	\captionsetup{justification=centering}
	\subfloat[Intervalo a 1 paso]{
		\includegraphics[width=0.5\textwidth]{imag/redes/p2_1c.pdf}}
	\subfloat[Intervalo a 6 paso]{
		\includegraphics[width=0.5\textwidth]{imag/redes/p2_6c.pdf}} \newline
	\subfloat[Intervalo a 12 paso]{
		\includegraphics[width=0.5\textwidth]{imag/redes/p2_12c.pdf}}
...
Como conclusión al análisis anterior se determina que el modelo 3 aún cuando requiere muy poca información no logra mantener un desempeño adecuado para las predicciones a 6 y 12 pasos, por lo cual no se recomienda su implementación. En cuanto al modelo 2 y 1, aún cuando su desempeño son similares se recomeinda utilizar el modelo 1, ya que el mismo incorpora la información de un día hacia atrás, pero si la situación reuiere un modelo más sencillo es bueno saber que se cuenta con un modelo con similar desempeño.
