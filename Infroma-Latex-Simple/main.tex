...
\begin{tabular}{|c|c|c|c|}
	...
	RMSE                      & 0.1938              & 0.7077              & 0.8847               \\ \hline
	MAPE                      & 67.71               & 159.78              & 169.81               \\ \hline
	MAE                       & 0.1344              & 0.5076              & 0.6814               \\ \hline
\end{tabular}
  \label{t_MDjp}%
\end{table}%
...
En la Fig. \ref{f_P1Covarianza} se muestra los intervalos difusos obtenidos para el método de la Covarianza, donde se puede observar y se corrobora con la Tabla \ref{t_Covarianza} para un $\alpha=10$ que el modelo estimado presenta un porcentaje de cobertura inicial de 100\% y que comienza a deteriorarze a medida que aumenta el paso de estimación del modelo. Ademas esto se logra con un ancho promedio porcentual del intervalo que se mantiene constante para los diferentes modelos obtenidos.
...
\begin{tabular}{|c|c|c|c|}
	...
	\multirow{2}{*}{Métricas} & \multicolumn{3}{c|}{Modelos}                                     \\ \cline{2-4} 
	& Predicción a 1 paso & Predicción a 8 paso & Predicción a 16 paso \\ \hline
	PICP                      & 100                 & 84.67               & 72                   \\ \hline
	PINAW                     & 27.59               & 29.55               & 28.1                 \\ \hline
\end{tabular}
  \label{t_Covarianza}%
\end{table}%
...
\begin{tabular}{|c|c|c|c|}
	...
	\multirow{2}{*}{Métricas} & \multicolumn{3}{c|}{Modelos}                                     \\ \cline{2-4} 
	& Predicción a 1 paso & Predicción a 8 paso & Predicción a 16 paso \\ \hline
	PICP                      & 96.92               & 73.50               & 63.33                \\ \hline
	PINAW                     & 30.91               & 31.11               & 31.49                \\ \hline
\end{tabular}
  \label{tab:addlabel}%
\end{table}%
