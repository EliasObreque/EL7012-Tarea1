...
Ya en el caso de la predicción a 12 pasos el intervalo difuso propuesto por el modelo no brinda una infromación muy precisa, pudiendo tomarse solo como una cota superior de la predicci?2n d ela variable pues falla en los valor cercanos a cero.
